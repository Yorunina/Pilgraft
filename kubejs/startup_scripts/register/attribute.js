...
StartupEvents.registry("attribute", event => {
     ...
     */
    event.createCustom("kubejs:natrue_bless", () => new $RangedAttribute("Nature Bless", 0, 0, 1024).setSyncable(true))
    /**
     * 星光庇佑：影响着所有星空系祈祷能力的效果
     * 包括增强遭遇新生态群系后对祈祷值的提高效果
     * 在遭遇新的结构时对祈祷值的提高效果
     */
    event.createCustom("kubejs:starlight_bless", () => new $RangedAttribute("StarLight Bless", 0, 0, 1024).setSyncable(true))
    /**
     * 洋流庇佑：影响着所有洋流系祈祷能力的效果
     * 包括增强在获得钓鱼战利品时对祈祷值的提高效果
     */
    event.createCustom("kubejs:ocean_bless", () => new $RangedAttribute("Ocean Bless", 0, 0, 1024).setSyncable(true))
    /**
     * 鲜血庇佑：影响着所有鲜血系祈祷能力的效果
     * 包括在击杀怪物后对祈祷值的提高效果
     */
    event.createCustom("kubejs:blood_bless", () => new $RangedAttribute("Blood Bless", 0, 0, 1024).setSyncable(true))
    /**
     * 命运庇佑：影响着所有命运系祈祷能力的效果
     * 包括在完成悬赏任务后对祈祷值的提高效果
     */
    event.createCustom("kubejs:fate_bless", () => new $RangedAttribute("Fate Bless", 0, 0, 1024).setSyncable(true))
    /**
     * 深渊庇佑：影响着所有深渊系祈祷能力的效果
     */
    event.createCustom("kubejs:abyss_bless", () => new $RangedAttribute("Abyss Bless", 0, 0, 1024).setSyncable(true))
})
